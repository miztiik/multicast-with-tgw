...
class MulticastProducerOnEC2Stack(cdk.Stack):
    ...
    def __init__(
        ...
        **kwargs
        ...
        app_server = _ec2.Instance(
            ...
            instance_name="multicast_producer_01",
        ...
        # Allow Multicast UDP
        multicast_producer_sg = _ec2.CfnSecurityGroup(
            self, "multicastProducerSG",
            group_description="Allow Multicast Traffic",
            group_name="multicastProducerSG",
        ...
        app_server.add_security_group(_ec2.SecurityGroup.from_security_group_id(
            self, "multicast_producer_sg1", security_group_id=multicast_producer_sg.attr_group_id))
